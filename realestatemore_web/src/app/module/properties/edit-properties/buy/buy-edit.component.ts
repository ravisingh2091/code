...
export class BuyEditComponent implements OnInit, AfterViewInit {
    ...
    formPatch() {
        ...
        this.postPropForm.patchValue({
            ...
            prices_per_meter: this.propertyDetail.pricePerMeter,
            ...
            football_area: this.propertyDetail.footballArea.toString(),
            green_area: this.propertyDetail.greenArea.toString(),
            volleyball: this.propertyDetail.volleyBall.toString(),
            playground: this.propertyDetail.playGround.toString(),
            wifi: this.propertyDetail.wifi.toString(),
            Furnished: this.propertyDetail.furniture.toString(),
