...
class MemberPending extends React.Component {
    state = {
        userList: [],
        totalUser: 0,
        loader: false,
    ...
    getMemeberList = (pageNo) => {
        ...
        axios.get(`/admin/userList?list=pending&page=${pageNo}`)
            .then(userList => {
    ...
    userConfirm = () => {
        ...
        if (userId) {
            axios.put(`/admin/userStatusManage?userId=${userId}`, { adminApproved: '1' })
                .then(result => {
