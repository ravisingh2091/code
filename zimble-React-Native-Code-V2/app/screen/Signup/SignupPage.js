// Sign Up 
// User will be able to perform the sign up in following 3 steps: 
...
// Note: Referral code will be optional, user will be able to enter the referral code if some of the app user shared the referral code with the user who is going to login into the platform.

// Referral code will be shared by app user (Parent only) to another new user so that he can sign up with the same referral code and the user who has been shared the referral code will get benefits for the same.
